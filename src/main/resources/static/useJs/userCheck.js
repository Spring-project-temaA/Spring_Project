...
function checkAll() {
    ...
    // 값이 비었는지 확인하기 위한 리스트
    let checkVal = [$('#userId').val(), $("#userPw").val(), $("#userPw2").val(), $("#userName").val(), $("#userPh").val(), $("#userMail").val(), $(".userGen").val()]
    // 값이 없을때를 알리기 위한 리스트
    let checkSpan = [$('.checkId'), $('.checkPw'), $('.checkPw2'), $('.checkName'), $('.checkPh'), $('.checkMail'), $('.checkGen')];
